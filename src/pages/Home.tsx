      ...
      <section id="what-we-do" className="py-16 px-6 bg-newtifi-navy">
        <div className="container mx-auto">
          <ScrollReveal className="mb-12 max-w-3xl mx-auto text-center">
            ...
            <p className="text-white text-opacity-80 text-sm font-light mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            <ScrollReveal delay={100}>
              <div className="bg-white bg-opacity-10 backdrop-blur-sm p-5 rounded-lg border border-white border-opacity-20 h-full">
                <h3 className="text-sm font-medium uppercase tracking-wider text-newtifi-teal mb-3">Research & Funding</h3>
            ...
            <ScrollReveal delay={200}>
              <div className="bg-white bg-opacity-10 backdrop-blur-sm p-5 rounded-lg border border-white border-opacity-20 h-full">
                <h3 className="text-sm font-medium uppercase tracking-wider text-newtifi-teal mb-3">Innovation & Development</h3>
                <ul className="text-white text-opacity-90 text-xs space-y-2 font-light">
            ...
            <ScrollReveal delay={300}>
              <div className="bg-white bg-opacity-10 backdrop-blur-sm p-5 rounded-lg border border-white border-opacity-20 h-full">
                <h3 className="text-sm font-medium uppercase tracking-wider text-newtifi-teal mb-3">Education & Support</h3>
                <ul className="text-white text-opacity-90 text-xs space-y-2 font-light">
            ...
            <ScrollReveal delay={400}>
              <div className="bg-white bg-opacity-10 backdrop-blur-sm p-5 rounded-lg border border-white border-opacity-20 h-full">
                <h3 className="text-sm font-medium uppercase tracking-wider text-newtifi-teal mb-3">Collaboration</h3>
                <ul className="text-white text-opacity-90 text-xs space-y-2 font-light">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <ScrollReveal delay={100} className="bg-gray-50 p-8 rounded-lg">
              <ul className="list-disc pl-5 text-sm text-gray-700 space-y-3 font-light mb-6">
            ...
            <ScrollReveal delay={200} className="hidden lg:block">
              <div className="bg-newtifi-navy p-8 rounded-lg text-white">
                <h3 className="text-base font-light mb-4 uppercase">RAIF Code Insights</h3>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto">
            ...
            <ScrollReveal delay={300}>
              <blockquote className="text-base font-light italic text-newtifi-navy border-l-4 border-newtifi-teal pl-5 mb-6">
