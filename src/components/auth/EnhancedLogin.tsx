// EnhancedLogin - Modern authentication component with Google API integration
...
const EnhancedLogin: React.FC<EnhancedLoginProps> = ({
  ...
  const { signInWithGoogle, signInWithEmail, registerWithEmail, loading, error, clearError } = useAuth();
  const { getProfile, hasPermissions } = useGoogleAPI();
        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-blue-100 mt-1">
                  {mode === 'login' ? 'Sign in to your account' : 'Join NewTIFI today'}
                </p>
              </div>
              <button
                onClick={onClose}
          ...
          <div className="p-6">
            ...
            <form onSubmit={handleEmailAuth} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={isSubmitting || loading || (mode === 'register' && formData.password !== formData.confirmPassword)}
