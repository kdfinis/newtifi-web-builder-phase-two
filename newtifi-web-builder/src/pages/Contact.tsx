    ...
    <main className="min-h-screen flex items-center justify-center bg-white">
      <div className="w-full max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-newtifi-navy/20 p-8">
          <h2 className="text-base font-semibold text-newtifi-navy mb-6">Send us a message</h2>
          <form className="space-y-5">
            ...
            <div>
              <label htmlFor="role" className="block text-base font-medium text-gray-700 mb-1">Role</label>
