...
// LinkedIn OAuth routes removed - handled by React component
// The React component handles LinkedIn OAuth directly
app.get('/auth/linkedin/callback', (req, res) => {
  // DISABLED - Let React component handle LinkedIn OAuth
  res.redirect('/login?error=linkedin_disabled&message=Use React component');
});
