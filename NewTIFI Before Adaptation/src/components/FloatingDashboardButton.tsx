...
const FloatingDashboardButton: React.FC = () => {
  ...
  return (
    <Link
      to="/dashboard"
      className="fixed bottom-6 right-6 z-50 bg-newtifi-teal hover:bg-newtifi-teal/90 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
