/**
 * Account Linking API
 * Server-side API endpoints for account linking functionality
 */
...
export class AccountLinkingAPI {
  /**
   * Link or create account for OAuth user (server-side)
   */
  static async linkOrCreateAccount(oauthData: {
  ...
  /**
   * Get all linked accounts for a user (server-side)
   */
  ...
  /**
   * Set primary account (server-side)
   */
